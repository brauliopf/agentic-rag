...
# async def process_source_play(url, description=None):
#     """Process a source URL and add it to the vector store"""
#     source_id = str(uuid.uuid4())
...
#         # use alternative scrapper
#         instructions = """
#             Get the content covered by this URL
#         """
#         # webscraper(url, instructions)

#         result, screenshot = await webscraper(url, instructions)
